            ...
            <div class="table-responsive">
                <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <?php
                           $statement = $pdo->prepare("SELECT * FROM tbl_services WHERE user_id =? && srvc_status='active' ORDER BY srvs_id DESC");
                            $statement->execute(array($user_result['id']));
                           // $statement->execute(array($_SESSION['provider']['id']));
                         ...
                         ?>
                                                        ...
                                                        <tr>
                            <td><?php echo $i;?></td>
                            <td><img width="60" src="../admin/assets/services/<?php echo $key['srvc_photo'];?>"></td>
