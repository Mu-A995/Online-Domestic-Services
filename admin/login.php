...
<html lang="en">
    <head>
        ...
        <title>Admin Panel - <?php echo $setting_statement_results['site_title']; ?></title>
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                    	<h3 class="text-center font-weight-light mt-4"><?php echo $setting_statement_results['site_title']; ?> - ADMIN LOGIN</h3>
                                    ...
                                    <div class="card-body">
                                    	...
                                    	<!-- <form method="post" action="">
                                    		...
                                    		<input required="true" type="text" name="username" placeholder="admin"><br>
